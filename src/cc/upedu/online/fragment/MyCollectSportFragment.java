...
/**
 * 侧拉栏，我的活动-收藏的活动的pager
 * 
 * @author Administrator
 * 
 */
public class MyCollectSportFragment extends RecyclerViewBaseFragment<ActivityItem> {
	private String userId;
	private String type;
	// 活动列表的Javabean文件
	private SportsBean bean;
	public MyCollectSportFragment(){

	}
	public MyCollectSportFragment(Context context) {
		super(context);
	}
	...
	private void setData() {
		...
		if (isAdapterEmpty()) {
			setRecyclerView(new SportAdapter(context, list),R.drawable.nocollect_sportdata);
	...
	public void initData() {
		...
		type="1";
			...
			requestDataMap = ParamsMapUtil.MySport(context, userId, type,String.valueOf(currentPage));
			RequestVo requestVo = new RequestVo(ConstantsOnline.MY_SPORT, context, requestDataMap, new MyBaseParser<>(SportsBean.class));
