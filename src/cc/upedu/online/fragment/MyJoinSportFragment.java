...
/**
 * 侧拉栏，我的活动-参加的活动的pager
 * 
 * @author Administrator
 * 
 */
public class MyJoinSportFragment extends RecyclerViewBaseFragment<ActivityItem> {
	private String userId;
	private String type;
	// 活动列表的Javabean文件
	private SportsBean bean;
	public MyJoinSportFragment(Context context) {
		super(context);
	}
	...
	private void setData() {
		...
		if (isAdapterEmpty()) {
			setRecyclerView(new SportAdapter(context, list),R.drawable.nojoin_sportdata);
