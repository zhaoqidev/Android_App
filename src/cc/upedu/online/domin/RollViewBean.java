...
public class RollViewBean {
	...
	public class Entity{
		private List<CourseItem> indexCenterBanner;
		
		public List<CourseItem> getindexCenterBanner() {
			return indexCenterBanner;
		}

		public void setindexCenterBanner(List<CourseItem> indexCenterBanner) {
			this.indexCenterBanner = indexCenterBanner;
		}

		@Override
		public String toString() {
			return "Entity [indexCenterBanner=" + indexCenterBanner + "]";
		}
