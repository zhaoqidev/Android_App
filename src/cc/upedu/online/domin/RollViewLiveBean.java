...
public class RollViewLiveBean {
	...
	public class Entity{
		...
		public List<CenterBannerItem> getliveCenterBanner() {
			return liveCenterBanner;
		}

		public void setliveCenterBanner(List<CenterBannerItem> liveCenterBanner) {
			this.liveCenterBanner = liveCenterBanner;
		}

		@Override
		public String toString() {
			return "Entity [liveCenterBanner=" + liveCenterBanner + "]";
		}

		public class CenterBannerItem{
