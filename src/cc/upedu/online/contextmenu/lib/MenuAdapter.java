...
//            mTextWrapper.addView(Utils.getItemTextView(mContext, menuObject, mMenuItemSize));
            mMenuWrapper.addView(Utils.getLayoutWrapper(mContext, menuObject, mMenuItemSize,
                    clickItem, longClickItem,mMenuObjects.size(), i));
        }
    }
...
//        fullAnimatorSet.playTogether(imageFullAnimatorSet, textFullAnimatorSet);
        fullAnimatorSet.playTogether(imageFullAnimatorSet);
    ...
    private AnimatorListener mCloseOpenAnimatorListener = new AnimatorListener() {
        @Override
    ...
    private AnimatorListener mChosenItemFinishAnimatorListener = new AnimatorListener() {
        @Override
        public void onAnimationStart(Animator animation) {
        }
