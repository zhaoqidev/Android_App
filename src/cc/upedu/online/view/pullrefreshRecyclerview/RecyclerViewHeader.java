...
package cc.upedu.online.view.pullrefreshRecyclerview;
...
public class RecyclerViewHeader extends RelativeLayout {
     ...
     * @return
     */
    public static RecyclerViewHeader getRecyclerViewHeader(Context context, View view) {
        RecyclerViewHeader header = new RecyclerViewHeader(context);
        header.addView(view);
        return header;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        System.out.println(String.valueOf(mRecyclerWantsTouchEvent));
