...
public class HeaderLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mProgressBar = (View) findViewById(R.id.pull_to_refresh_header_progressbar);
    ...
    public void setLastUpdatedLabel(CharSequence label) {
        ...
        mHeaderTimeViewTitle.setVisibility(StringUtil.isEmpty(label) ? View.INVISIBLE : View.VISIBLE);
