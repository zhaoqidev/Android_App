...
import cc.upedu.online.view.pullrefreshview.ILoadingLayout.State;
...
//    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            final float absXDiff = Math.abs(deltaX);
            // 这里有三个条件：
            ...
            if (absDiff > mTouchSlop || isPullRefreshing() || isPullLoading())  {
                ...
                if (isPullRefreshEnabled() && isReadyForPullDown()) {
                    ...
                    mIsHandledTouchEvent = (Math.abs(getScrollYValue()) > 0 || deltaY > 0.5f)&&(absXDiff<absDiff);
