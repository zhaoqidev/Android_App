...
import cc.upedu.online.activity.MyNoteOneCourseEditActivity;
...
public class OneCourseListAdapter extends BaseMyAdapter<NoteItem> {
	String courseId;
	String type;
	public OneCourseListAdapter(Context context, List<NoteItem> list, String courseId,String type) {
		super(context, list);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (0 == Integer.valueOf(type)) {
			holder.iv_edit.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent intent = new Intent(context, MyNoteOneCourseEditActivity.class);
					intent.putExtra("noteItem", (Serializable)list.get(position));
