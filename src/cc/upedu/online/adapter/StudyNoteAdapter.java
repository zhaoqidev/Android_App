...
public class StudyNoteAdapter extends AbsRecyclerViewAdapter {
	
	public StudyNoteAdapter(Context context, List<NoticeItem> mNoticeList) {
		this.list = mNoticeList;
	...
	public void onBindViewHolder(ViewHolder viewHolder, int position) {
		final NoticeItem item = (NoticeItem) list.get(position);
		...
		holder.note_user_image.setOnClickListener(new OnClickListener() {
