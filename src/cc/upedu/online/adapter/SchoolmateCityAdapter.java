 ...
 * 
 */
public class SchoolmateCityAdapter extends AbsRecyclerViewAdapter {


	public SchoolmateCityAdapter(Context context, List<SchoolmateItem> list) {
		this.list = list;
