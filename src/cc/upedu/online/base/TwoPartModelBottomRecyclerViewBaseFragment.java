...
/**
 * 基于TwoPartModelTopBaseFragment,下方部分是list的fragment
 * 
 * @author Administrator
 * 
 */
public abstract class TwoPartModelBottomRecyclerViewBaseFragment<T> extends
		TwoPartModelBottomBaseFragment implements PullLoadMoreListener{
	...
	/**
	 * 配置PullLoadMoreRecyclerView 可以调用 ：setIsRefresh()设置是否为刷新状态
