...
/**
 * 基于TwoPartModelBottomActivity,上方部分为GridView下方为包裹内容的布局
 * @author Administrator
 *
 */
public abstract class TwoPartModelGridViewBottomBaseActivity extends TwoPartModelBottomBaseActivity {
	/**
	 * gridview对象
	 */
	private GridView gv;
