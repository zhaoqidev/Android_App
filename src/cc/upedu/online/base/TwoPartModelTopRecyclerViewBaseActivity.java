...
/**
 * 基于TwoPartModelTopActivity,下方部分为listview上方为包裹内容的布局
 * @author Administrator
 *
 */
public abstract class TwoPartModelTopRecyclerViewBaseActivity<T> extends TwoPartModelTopBaseActivity implements PullLoadMoreListener{
